...
@section('content')
    ...
    <!-- ----------------------------------- ADD MOVIE FORM ----------------------------------- -->
		...
		<div class="row form-group">
			...
			<div class="col-sm-10">
				<input type="text" id="name" class="form-control" name="movie_name" placeholder="Spiderman: Home Coming"><br>
			</div>
		...
		<div class="row form-group">
			...
			<label class="col-sm-2 col-form-label">Movie Description</label>				
			<div class="col-sm-10">
		...
		<div class="row form-group">
			...
			<label class="col-sm-2 col-form-label">Year of Release</label>
			<div class="col-sm-3">
		...
		<div class="row form-group">
			...
			<label class="col-sm-2 col-form-label" for="img">Cover Picture</label>
			<div class="col-sm-3">
